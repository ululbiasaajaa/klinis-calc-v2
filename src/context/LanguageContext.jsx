...
export const translations = {
  id: {
    ...
    navPregnancy: 'Usia Kehamilan & HPL (Obgin)',
    navRenalDose: 'Auto-Checker Dosis Ginjal',
  ...
  en: {
    ...
    navPregnancy: 'Gestational Age & EDD (OB/GYN)',
    navRenalDose: 'Renal Dosing Auto-Checker',
