...
export default function FraminghamCalculator() {
  ...
  const parsedHdl = parseFloat(hdl);
  const parsedTc = parseFloat(totalChol);
  const parsedSbp = parseFloat(sbp);

  const a = isNaN(parsedAge) ? 50 : parsedAge;
  const h = isNaN(parsedHdl) ? 50 : parsedHdl;
  const tc = isNaN(parsedTc) ? 200 : parsedTc;
  const s = isNaN(parsedSbp) ? 120 : parsedSbp;
  ...
  const riskResult = { points, riskPercent, category, colorBadge };
    ...
    <div className="space-y-6 text-xs">
      ...
      <div className={`p-4 rounded-xl border ${isDark ? 'bg-slate-950/50 border-slate-800' : 'bg-slate-50 border-slate-200'}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="gender-select" className={`block mb-1 font-semibold ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>Jenis Kelamin</label>
            <select
              id="gender-select"
              value={gender}
          ...
          <div>
            <label htmlFor="age-input" className={`block mb-1 font-semibold ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>Usia (Tahun)</label>
            <input
              id="age-input"
              type="number"
              value={age}
          ...
          <div>
            <label htmlFor="smoke-select" className={`block mb-1 font-semibold ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>Riwayat Merokok</label>
            <select
              id="smoke-select"
              value={smoke}
          ...
          <div>
            <label htmlFor="diabetes-select" className={`block mb-1 font-semibold ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>Riwayat Diabetes Mellitus</label>
            <select
              id="diabetes-select"
              value={diabetes}
          ...
          <div>
            <label htmlFor="total-chol-input" className={`block mb-1 font-semibold ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>Kolesterol Total (mg/dL)</label>
            <input
              id="total-chol-input"
              type="number"
              value={totalChol}
          ...
          <div>
            <label htmlFor="hdl-input" className={`block mb-1 font-semibold ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>Kolesterol HDL (mg/dL)</label>
            <input
              id="hdl-input"
              type="number"
              value={hdl}
          ...
          <div>
            <label htmlFor="sbp-input" className={`block mb-1 font-semibold ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>Tekanan Darah Sistolik (mmHg)</label>
            <input
              id="sbp-input"
              type="number"
              value={sbp}
          ...
          <div>
            <label htmlFor="treated-bp-select" className={`block mb-1 font-semibold ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>Sedang Minum Obat Hipertensi?</label>
            <select
              id="treated-bp-select"
              value={treatedBp}
